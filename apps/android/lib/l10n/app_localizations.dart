...
abstract class AppLocalizations {
  ...
  /// No description provided for @settingsImportScanQr.
  ///
  /// In en, this message translates to:
  /// **'Scan QR'**
  String get settingsImportScanQr;
  ...
  /// No description provided for @settingsImportQrInvalid.
  ///
  /// In en, this message translates to:
  /// **'QR code does not contain a tt:// link'**
  String get settingsImportQrInvalid;
  ...
  /// No description provided for @qrScannerTorch.
  ///
  /// In en, this message translates to:
  /// **'Flashlight'**
  String get qrScannerTorch;

  /// No description provided for @qrScannerClose.
  ///
  /// In en, this message translates to:
  /// **'Close'**

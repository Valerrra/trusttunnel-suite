...
class AppLocalizationsRu extends AppLocalizations {
  ...
  String get mobileHomeInfoLine1 =>
      'Импортируйте TrustTunnel-ссылку tt:// из буфера обмена или через экран настроек.';

  @override
  String get mobileHomeInfoLine2 =>
      'Эта Android-сборка уже сохраняет профили и проверяет import flow.';

  @override
  String get mobileHomeInfoLine3 =>
      'Нативный Android VPN backend будет следующим этапом.';

  @override
  String get mobileBackendPending =>
      'Android VPN backend пока не интегрирован.';

  @override
  String get mobileLogsHint =>
      'Импортируйте профиль или нажмите подключение, чтобы увидеть логи Android prototype.';
  ...
  @override
  String get settingsImportScanQr => 'Сканировать QR';
  ...
  @override
  String get settingsImportQrInvalid => 'QR-код не содержит `tt://` ссылку';
  ...
  @override
  String get qrScannerHint => 'Наведите камеру на QR-код с ссылкой `tt://`.';

  @override
  String get qrScannerTorch => 'Фонарик';

  @override
  String get qrScannerClose => 'Закрыть';

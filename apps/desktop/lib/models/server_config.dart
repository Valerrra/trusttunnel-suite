...
class ServerConfig {
  ...
  factory ServerConfig.fromJson(Map<String, dynamic> json) {
    ...
    final autoStartWithWindows =
        json['autoStartWithWindows'] as bool? ?? false;
    final autoConnectOnLaunch =
        json['autoConnectOnLaunch'] as bool? ?? false;
    final launchMinimized = json['launchMinimized'] as bool? ?? false;
